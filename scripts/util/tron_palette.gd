...
const BG: Color = Color(0.0392, 0.0392, 0.102)
...
const HULL_GLOW: Color = Color(0.18, 0.55, 1.00, 0.45)
const HULL_LINE: Color = Color(0.55, 0.95, 1.00, 1.00)
const HULL_BRIGHT: Color = Color(0.92, 1.00, 1.00, 1.00)
...
const ACCENT: Color = Color(1.00, 0.55, 0.15, 1.00)
const ACCENT_GLOW: Color = Color(1.00, 0.45, 0.10, 0.55)

# Cockpit core — bright diamond + soft halo underlayer.
const COCKPIT: Color = Color(0.92, 1.00, 1.00, 1.00)
const COCKPIT_GLOW: Color = Color(0.25, 0.75, 1.00, 0.55)

# Engine exhaust — additive teal jet flame.
const ENGINE_PORT: Color = Color(0.20, 0.60, 1.00, 0.55)
const PORT_CORE: Color = Color(0.85, 1.00, 1.00, 0.90)
const FLAME_OUTER: Color = Color(0.10, 0.60, 1.00, 0.95)
const FLAME_INNER: Color = Color(0.85, 1.00, 1.00, 0.95)
...
const RING_GLOW: Color = Color(0.18, 0.55, 1.00, 0.15)
const RING_LINE: Color = Color(0.45, 0.95, 1.00, 0.475)
const RING_BRIGHT: Color = Color(0.85, 1.00, 1.00, 0.50)
const RING_ALPHA_MAX: float = 0.5
const RING_PULSE_MIN: float = 0.35
const RING_PULSE_SPEED: float = 2.5

const ASTEROID_TRAIL: Color = Color(1.00, 0.08, 0.00, 1.00)
