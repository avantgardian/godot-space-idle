...
func apply_to_shader(mat: ShaderMaterial) -> void:
	...
	mat.set_shader_parameter("u_terra_ice_cap", ice_cap)
	mat.set_shader_parameter("u_ocean_deep", ocean_deep)
	mat.set_shader_parameter("u_ocean_shallow", ocean_shallow)
	mat.set_shader_parameter("u_land_tropical", land_tropical)
	mat.set_shader_parameter("u_land_desert", land_desert)
	mat.set_shader_parameter("u_land_tundra", land_tundra)
	mat.set_shader_parameter("u_terra_cloud_white", cloud_white)
	mat.set_shader_parameter("u_terra_specular", ocean_specular)
