...
const STAR_TYPES: Array[Dictionary] = [
	{
		...
		tex_size = 320,
		weight = 3,
		core_0 = Color(0.7, 0.85, 1.0),
		core_1 = Color(0.5, 0.7, 0.95),
		core_2 = Color(0.3, 0.5, 0.8),
		glow_tint = Color(0.6, 0.8, 1.0),
		base_mod = Color(0.5, 0.7, 1.0),
		hot_mod = Color(0.7, 0.9, 1.0),
		limb_strength = 0.20,
		granulation_scale = 1.6,
		spot_regime = "none",
		spot_count = 0,
		corona_falloff = 1.0,
		corona_radius_mult = 2.6
	},
	{
		type = "B5V",
		mass_min = 4.0,
		...
		tex_size = 288,
		weight = 7,
		core_0 = Color(0.8, 0.9, 1.0),
		core_1 = Color(0.7, 0.8, 0.95),
		core_2 = Color(0.5, 0.65, 0.85),
		glow_tint = Color(0.7, 0.8, 1.0),
		base_mod = Color(0.65, 0.8, 0.95),
		hot_mod = Color(0.8, 0.9, 1.0),
		limb_strength = 0.30,
		granulation_scale = 1.6,
		spot_regime = "none",
		spot_count = 0,
		corona_falloff = 1.2,
		corona_radius_mult = 2.3
	},
	{
		type = "A5V",
		mass_min = 1.8,
		...
		tex_size = 272,
		weight = 12,
		core_0 = Color(1.0, 1.0, 1.0),
		core_1 = Color(0.95, 0.95, 0.9),
		core_2 = Color(0.85, 0.85, 0.7),
		glow_tint = Color(0.95, 0.95, 0.85),
		base_mod = Color(0.9, 0.9, 0.85),
		hot_mod = Color(0.85, 0.9, 1.0),
		limb_strength = 0.50,
		granulation_scale = 1.6,
		spot_regime = "none",
		spot_count = 0,
		corona_falloff = 1.6,
		corona_radius_mult = 1.9
	},
	{
		type = "F5V",
		mass_min = 1.1,
		...
		tex_size = 264,
		weight = 18,
		core_0 = Color(1.0, 1.0, 0.9),
		core_1 = Color(1.0, 0.95, 0.8),
		core_2 = Color(0.9, 0.8, 0.5),
		glow_tint = Color(1.0, 0.95, 0.7),
		base_mod = Color(1.0, 0.95, 0.7),
		hot_mod = Color(0.95, 0.95, 0.9),
		limb_strength = 0.60,
		granulation_scale = 1.4,
		spot_regime = "equatorial",
		spot_count = 3,
		corona_falloff = 2.0,
		corona_radius_mult = 1.7
	},
	{
		type = "G2V",
		mass_min = 0.8,
		...
		tex_size = 256,
		weight = 20,
		core_0 = Color(1.0, 0.95, 0.8),
		core_1 = Color(1.0, 0.7, 0.2),
		core_2 = Color(0.8, 0.3, 0.05),
		glow_tint = Color(1.0, 0.5, 0.1),
		base_mod = Color(1.0, 1.0, 0.5),
		hot_mod = Color(1.0, 0.35, 0.05),
		limb_strength = 0.65,
		granulation_scale = 1.0,
		spot_regime = "equatorial",
		spot_count = 4,
		corona_falloff = 2.2,
		corona_radius_mult = 1.6
	},
	{
		type = "K5V",
		mass_min = 0.4,
		...
		tex_size = 224,
		weight = 22,
		core_0 = Color(1.0, 0.8, 0.5),
		core_1 = Color(1.0, 0.55, 0.2),
		core_2 = Color(0.7, 0.2, 0.05),
		glow_tint = Color(1.0, 0.5, 0.1),
		base_mod = Color(1.0, 0.7, 0.3),
		hot_mod = Color(1.0, 0.3, 0.05),
		limb_strength = 0.75,
		granulation_scale = 0.7,
		spot_regime = "equatorial",
		spot_count = 5,
		corona_falloff = 2.5,
		corona_radius_mult = 1.4
	},
	{
		type = "M4V",
		mass_min = 0.1,
		...
		tex_size = 192,
		weight = 18,
		core_0 = Color(1.0, 0.5, 0.25),
		core_1 = Color(0.9, 0.3, 0.1),
		core_2 = Color(0.5, 0.1, 0.02),
		glow_tint = Color(1.0, 0.3, 0.05),
		base_mod = Color(0.95, 0.4, 0.15),
		hot_mod = Color(0.6, 0.1, 0.02),
		limb_strength = 0.85,
		granulation_scale = 0.5,
		spot_regime = "polar",
		spot_count = 4,
		corona_falloff = 3.0,
		corona_radius_mult = 1.25
	},
]
...
func _process(delta):
	...
	_spaceship.input_active = cam_following_ship
	var barrier_r: float = (
		OrbitalBody.sun_collision_r(sun_mass) + _spaceship.collision_radius + 50.0
	)
	_spaceship.enforce_sun_barrier(barrier_r)
		...
		for a in _spawner._asteroids:
			if a.is_alive():
				...
				if d < nearest_dist:
					...
					nearest = a
		if nearest:
			var rocket: Rocket = _spaceship.try_fire(nearest)
			if rocket:
				add_child(rocket)
...
func _on_key_pressed(event):
	if event.is_action_pressed("toggle_ship_follow"):
		if _camera.is_following() and _camera.get_follow_target() == _spaceship:
			...
			_camera.follow_node(_spaceship)
