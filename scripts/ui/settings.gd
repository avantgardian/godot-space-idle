...
const _SM: GDScript = preload("res://scripts/util/settings_manager.gd")
...
func _setup_background() -> void:
	...
	var grid_mat: ShaderMaterial = ShaderMaterial.new()
...
func _setup_rebind_popup() -> void:
	...
	var popup_bg: ColorRect = ColorRect.new()
...
func _build_ui() -> void:
	...
	# ---- Header ----
	var header: CenterContainer = CenterContainer.new()
	...
	var cb_option: OptionButton = OptionButton.new()
